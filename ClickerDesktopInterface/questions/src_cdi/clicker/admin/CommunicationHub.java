...
public class CommunicationHub 
{
    ...
    private QuestionOptionsFrame questionOptionsFrame;
...
//    	this.password = password;
    ...
    public void sendQuestion(String question) 
    {
    	...
    	questionOptionsFrame = new QuestionOptionsFrame(question);
//    	if (classModel.getGroups().size() > 1)
//    	{
//    		groupSelectFrame = new GroupSelectionFrame(question);
//    	}
//    	else
//    	{
//    		selectDisplay(question, "Ungrouped"); // Ungrouped should be Everyone
//    	}
    }
    
//    public void selectDisplay(String question, String groups)
//    {
...
//					Constants.AMPERSAND_SEPARATOR + Constants.AMPERSAND_SEPARATOR + groups);
//    	}
//    	else
//    	{
//    		displaySelectFrame = new ConsumerSelectionFrame(question, groups);
//    	}
//    }
    ...
    public class QuestionOptionsFrame extends JFrame
    {
    	private ArrayList<JCheckBox> groupsCheckList;
    	private ArrayList<JCheckBox> consumersCheckList;
    	private static final int MAX_WIDTH = 220;
    	private static final int MAX_HEIGHT = 400;
    	public QuestionOptionsFrame(String question)
    	{
    		super();
        	setTitle("Groups");
...
//        	consumersCheckList = new ArrayList<JCheckBox>();
//        	Object[] displayArray =  consumerSet.toArray();
//        	
//        	consumersPanel.setLayout(new GridLayout(displayArray.length + 1, 1));
//        	for (int i=0; i < displayArray.length; i++) 
//        	{
//        		String conString = (String) displayArray[i];
//        		
//        		// Cut the conString up to just get the name of the consumer
//        		String[] conName = conString.split(Constants.COLON_SEPARATOR);
//        		JCheckBox temp = new JCheckBox(conName[0]);
//        		temp.setActionCommand(conString);
//        		consumersCheckList.add(temp);
//        		consumersPanel.add(temp);
//        		if (!defaultConsumer.equals("") && conString.equals(defaultConsumer))
...
//    				String consumers = "";
//    				for (JCheckBox box : consumersCheckList)
//    				{
//    					if (box.isSelected())
//    						consumers += box.getActionCommand() + Constants.COMMA_SEPARATOR;
//    				}
//    				
//    				consumers = consumers.substring(0, consumers.length() - 3);
    				...
    				questionOptionsFrame.setVisible(false);
